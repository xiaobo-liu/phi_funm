function [th_max,h] = myperfprof(A,th_max,colors,markers,markersize,linewidth)

%PERFPROF Produce performance profile (edited for our need)
...
% corresponding to the j-th solver.
    ...
    for j = 1:n
        ...
        plot(theta(1:p_step:end), T(1:p_step:end), markers{j},...
